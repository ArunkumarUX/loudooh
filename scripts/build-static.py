...
FORMATS = [
    ("6-Sheet Posters", "Print", "The workhorse format. Backlit panels on platforms, in ticket halls and at entrances — passengers waiting for a train are directly in front of them with nothing else demanding attention. Present at 1,000+ UK stations.", [("Regional", "£300 / panel"), ("Major regional", "£500 / panel"), ("London termini", "£1,200 / panel")], "Frequency campaigns against commuters; local business targeting."),
    ("Digital 6-Sheets (D6)", "Digital", "The digital equivalent on station screen networks. Ads rotate on a timed loop with daypart targeting, no print cost, and creative changeable remotely mid-campaign. The fastest-growing segment of rail inventory.", [("Regional", "£400 / screen"), ("Major regional", "£550 / screen"), ("London termini", "£2,200 / screen")], "Targeting specific commuter windows; brands needing creative flexibility."),
    ("48 & 96-Sheet Billboards", "Print", "Large format on station approaches, alongside tracks at platform ends, and on exterior walls. Trackside 48-sheets are seen from arriving and departing trains too, adding an on-train audience. Often surprisingly good value regionally.", [("Regional", "£1,200"), ("Major regional", "£2,000"), ("London termini", "£4,500")], "Brand awareness at scale; creative that benefits from a large canvas."),
    ("Large Format Digital", "Digital", "The premium station format. Full-motion screens above concourses, facing departure boards. When 500 people are staring at the boards, the screen beside them has their attention by default — among the most valuable OOH sites in the country.", [("Regional", "£1,800"), ("Major regional", "£2,500"), ("London termini", "£9,000")], "High-impact brand campaigns, launches, motion-led creative."),
    ("Concourse & Experiential", "Experiential", "Floor-standing sites on main concourses for product displays, sampling and pop-ups. The larger termini have designated experiential zones with power and footfall in the tens of thousands daily. Puts your brand in the path of the audience.", [("Regional", "£1,200 / wk"), ("Major regional", "£1,800 / wk"), ("London termini", "£7,000 / wk")], "Product sampling, launches, brands that benefit from interaction."),
    ("Station Takeovers", "Domination", "Complete brand presence across a station: every panel, every screen, often wraps on barriers, floors and architecture. Takeovers at the major London termini generate press and social coverage in their own right.", [("Regional", "£15,000"), ("Major regional", "£35,000"), ("London termini", "£75,000+")], "Major launches and brand moments; saturating a catchment."),
    ("Traincards (interior)", "Print", "Printed panels inside carriages, above windows and seats. Commuters sit facing them for a 30–45 minute journey, so traincards support longer copy and direct-response mechanics like QR codes. Sold in fleet packages.", [("Per panel", "£18 / 2 wks"), ("Typical fleet", "500–2,000 panels"), ("1,000-panel pkg", "from £18,000")], "Detailed messaging, recruitment, financial services, direct response."),
    ("Train Exterior Wraps", "Domination", "Full or partial branding on the outside of trains — the train becomes a moving campaign across its whole route, seen at every station it calls at and every platform it passes. High production cost, priced on application.", [("Regional", "POA"), ("Major regional", "POA"), ("London termini", "from £25,000")], "Major brand campaigns, tourism bodies, route-level partnerships."),
]

RATE_CARD = [
    ("6-sheet poster", "£300 / panel", "£500 / panel", "£1,200 / panel", "Widest availability, 1,000+ stations"),
    ("Digital 6-sheet (D6)", "£400 / screen", "£550 / screen", "£2,200 / screen", "Daypart targeting available"),
    ("48-sheet billboard", "£1,200", "£2,000", "£4,500", "Includes trackside sites"),
    ("Large format digital", "£1,800", "£2,500", "£9,000", "Premium concourse positions"),
    ("Concourse experiential", "£1,200 / wk", "£1,800 / wk", "£7,000 / wk", "Staffing & build additional"),
    ("Station domination", "£15,000", "£35,000", "£75,000+", "8–12 weeks lead time"),
    ("Traincards (interior)", "£18 / panel", "£18 / panel", "£18 / panel", "Sold in fleet packages"),
    ("Train exterior wrap", "POA", "POA", "from £25,000", "Production significant, 12+ weeks"),
]
...
FAQS = [
    ("How much does rail advertising cost in the UK?", "Based on the Loud! OOH 2026 rate card, station 6-sheet posters start from £300 per panel per two weeks at regional stations, rising to £1,200 per panel at the London termini. A realistic first campaign for an SME at a major regional station, combining several panels with a digital rotation, would typically cost £4,000 to £10,000 for two to four weeks. Premium large format digital at a London terminus starts from around £9,000 per two weeks. Station takeovers run from £15,000 at regional stations to £75,000 and beyond at the London termini. See the full rate card at loudooh.co.uk/pricing."),
